...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo3305.juesi.eu.org';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || '{"AccountTag":"8296b473f2873c30e207ed4dce084111","TunnelSecret":"UAbjksjNJ7oCgeexwVjX/b/8eHI103t1smyiGQkHND4=","TunnelID":"d0e733e2-e2bf-4086-a11a-6a44bbe556bc"}';
